...
const loaders: Record<Locale, () => Promise<Dictionary>> = {
  ...
  "zh-cn": async () => (await import("./messages/zh-cn")).default as unknown as Dictionary,
  "zh-tw": async () => (await import("./messages/zh-tw")).default as unknown as Dictionary,
  ...
  ur: async () => (await import("./messages/ur")).default as unknown as Dictionary,
  pl: async () => (await import("./messages/pl")).default as unknown as Dictionary,
  ro: async () => (await import("./messages/ro")).default as unknown as Dictionary,
