    ...
    <header className="sticky top-0 z-50 bg-navy text-white border-b border-white/10">
      <div className="max-w-lg mx-auto px-4 flex items-center justify-between min-h-14">
        <Link href={localizedPath(locale, "app")} className="flex flex-col leading-tight">
          <span className="text-sm font-semibold tracking-tight">{dict.app.brand}</span>
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="hidden sm:inline text-[10px] uppercase tracking-wider text-white/60 hover:text-white transition-colors"
          >
